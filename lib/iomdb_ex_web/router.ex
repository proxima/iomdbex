defmodule IomdbExWeb.Router do
  ...
  scope "/", IomdbExWeb do
    ...
    live "/slot_affects", SpSlotAffectLive.Index, :index
    live "/slot_affects/new", SpSlotAffectLive.Index, :new
    live "/slot_affects/:id/edit", SpSlotAffectLive.Index, :edit
    live "/slot_affects/:id", SpSlotAffectLive.Show, :show
    live "/slot_affects/:id/show/edit", SpSlotAffectLive.Show, :edit
